...
public class MainApp {
    public static void main(String[] args) {
        ...
        // helloWorldA.setMessage("A");
        // HelloWorld helloWorldB = (HelloWorld) context.getBean("hello");
        // helloWorldB.setMessage("B");
        helloWorldA.getMessage();
        // helloWorldB.getMessage();

        // context = new
        // FileSystemXmlApplicationContext("D:\\data\\study.note\\jar\\spring\\beans.xml");
        // helloWorld = (HelloWorld) context.getBean("hello");
